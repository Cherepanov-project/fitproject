...
jest.mock("next/image", () => {
  return function DummyImage(){return<div></div>};
});
let container = null;
beforeEach(() => {
...
it("Cookies filled", async () => {
  ...
  document.querySelector("input[type='email']").setAttribute('value','testAdmin1992');
  document.querySelector("input[type='password']").setAttribute('value','testAdmin');
