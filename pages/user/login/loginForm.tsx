...
export const LoginForm: React.FC = () => {
	...
	const [values, setValues] = React.useState<ILoginForm>({
		userName: "",
		email: "",
		password: "",
	});
	...
	const registerUser = async (data: ILoginForm, resetForm: Function) => {
		try {
			if (data) {
				...
				<form onSubmit={handleSubmit} >
					<FormWrapper >
						<FormControl variant="outlined" >
							<InputLabel>Enter email or user name</InputLabel>
							<OutlinedInput
								id="email"
								type="email"
								value={values.email}
